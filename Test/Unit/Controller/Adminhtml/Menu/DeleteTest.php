...
use Logic\CustomMenu\Controller\Adminhtml\Menu\Delete;
/**
...
{
    /**
     * @var \Logic\CustomMenu\Controller\Adminhtml\Block\Delete
     */
    ...
    protected function setUp()
    {
       ...
       $this->menuMock = $this->getMockBuilder('Logic\CustomMenu\Model\Menu')->disableOriginalConstructor()->getMock();
        ...
        //     'Logic\CustomMenu\Controller\Adminhtml\Block\Delete',
        //     [
    ...
    public function testDeleteActionNoId()
    {
        ...
        $this->messageManagerMock->expects($this->once())
            ->method('addError')
            ->with(__('We can\'t find a menu to delete.'));
        $this->messageManagerMock->expects($this->never())
            ->method('addSuccess');
    ...
    {
        $errorMsg = 'Can\'t create the menu';
